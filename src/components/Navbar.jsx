...
const NavLinks = ({ className }) => {
  ...
  const isTenant = location.pathname === '/dashboard' || localStorage.getItem('userType') === 'tenant';
      ...
      {links.map(link => {
        ...
        return (
             ...
             className={cn(
               ...
               isActive 
                 ? "text-rentz-purple bg-rentz-purple/10 font-semibold" 
                 : "text-gray-700 hover:text-rentz-purple hover:bg-gray-100"
             )}
